...
│   ├── page.tsx                  # Main application page (orchestrates entire lab)
│   ├── layout.tsx                # Root layout with metadata
│   └── globals.css               # Global styles and Tailwind CSS
│
├── components/                   # React components
│   ├── Stage.tsx                 # Main workspace (drag-and-drop canvas)
│   ├── Sidebar.tsx               # Progress, performance metrics, and logs
│   ├── WikiPanel.tsx             # Educational content panel
│   ├── DraggableCanvas.tsx       # Canvas for module placement and connections
│   ├── MotherboardBuilder.tsx    # Hardware assembly interface
│   ├── WindowsVM.tsx             # Windows virtual machine UI
│   ├── LinuxVM.tsx               # Linux terminal VM UI
│   ├── Window.tsx                # Draggable window wrapper
│   ├── InfoTooltip.tsx           # Tooltip component
│   │
│   ├── modals/                   # Configuration modals
│   │   ├── HardwareModal.tsx     # Hardware selection and installation
│   │   ├── OSModal.tsx           # Operating system selection
│   │   ├── NetworkModal.tsx      # Network configuration
│   │   └── BenchmarkModal.tsx    # Performance benchmarking
│   │
│   └── nodes/                    # Canvas node components
│       ├── PCTower.tsx           # PC tower node
│       ├── Monitor.tsx           # Monitor node
│       └── Router.tsx            # Router node
│
